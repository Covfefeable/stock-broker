...
class IndexDailyBar(db.Model):
    __tablename__ = "index_daily_bars"

    id = db.Column(db.Integer, primary_key=True)
    index_asset_id = db.Column(db.Integer, db.ForeignKey("index_assets.id"), nullable=True, index=True)
    ...
    index_asset = db.relationship("IndexAsset")
